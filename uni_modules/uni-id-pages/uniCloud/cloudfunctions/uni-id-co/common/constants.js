...
const inviteCollectionName = 'aicare-invite-info'
const inviteCollection = db.collection(inviteCollectionName)
const scoresCollection = db.collection('uni-id-scores');
