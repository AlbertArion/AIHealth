	...
	<view class="about">
		<view class="box">
			...
			<view @click="download" id="download">
				<image v-if="isIos" class="icon" mode="widthFix"
					src="https://mp-d4a734ea-9ae3-4448-99e4-ae65b22bbaf4.cdn.bspapp.com/xinmai/download/ios.png">
					<image v-else class="icon" mode="widthFix"
						src="https://mp-d4a734ea-9ae3-4448-99e4-ae65b22bbaf4.cdn.bspapp.com/xinmai/download/android.png" />
