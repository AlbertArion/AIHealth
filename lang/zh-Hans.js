export default {
	...
	dialogTitle: '心脉AI',
	appTips: '温馨提示',
	appContent: '感谢您信任并使用心脉AI。\n1、为了便于您更详细了解您的权利和义务，请您仔细阅读心脉AI《用户协议》与《隐私政策》并做出是否同意授权的决定。\n2、心脉AI团队重视用户隐私并严格按照相关法律法规的要求以及心脉AI《用户协议》与《隐私政策》所约定的方式进行内容收集、使用用户信息。\n3、据您使用服务的具体功能，需要收集使用信息，可能使用您的一下权限：\n（1）存储权限、相册权限：健康模块上传病历。\n（2）麦克风权限、音频播放权限：智能问答和反馈语音录入，智能问答语音播报。\n4、您根据指引注册登录并继续使用我们的各项服务时，需同意我们的《用户协议》与《隐私政策》，否则您只能浏览部分内容和使用部分服务。',
	common: {
		wechatFriends: "微信好友",
		wechatBbs: "微信朋友圈",
		weibo: "微博",
